...
def main():
    ...
    if result == TaskResult.SUCCEEDED:
        print('Goal succeeded! Achieved {} goals.'.format(len(goal_poses)))
    elif result == TaskResult.CANCELED:
        print('Goal was canceled! Achieved {} goals before cancellation.'.format(len(goal_poses)))
    elif result == TaskResult.FAILED:
        (error_code, error_msg) = navigator.getTaskError()
        print('Goal failed! {}:{}'.format(error_code, error_msg))
    else:
